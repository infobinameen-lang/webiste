        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-primary-foreground/80 mb-4">
              Professional consulting services in education, research, business development, and teacher training
              programmes.
            </p>
            <div className="text-sm text-primary-foreground/60">TRCN Registered • Established Excellence</div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <PhoneIcon />
                <span className="text-primary-foreground/80">+234 703 036 3774</span>
              </div>
              <div className="flex items-center gap-2">
                <MailIcon />
                <span className="text-primary-foreground/80">info.binameen@gmail.com</span>
              </div>
              <div className="flex items-center gap-2">
                <MapPinIcon />
